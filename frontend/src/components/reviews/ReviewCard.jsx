...
function ReviewCard({
    ...
    return (
        <motion.div
            ...
            style={theme}
            className="bg-surface-50/50 rounded-2xl shadow-sm border border-surface-200 border-l-3 border-l-secondary-400 overflow-hidden transition-transform duration-200 hover:-translate-y-px hover:shadow-md"
        >
